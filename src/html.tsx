	...
	return (
		<html lang="en">
			<head>
				...
				<link rel="preload" href={`${config.siteMetadata.url}/fonts/paperboy-headings-bold.woff2`} type="font/woff2" as="font" crossorigin />
				<link rel="preload" href={`${config.siteMetadata.url}/fonts/paperboy-headings-regular.woff2`} type="font/woff2" as="font" crossorigin />
				<link rel="preload" href={`${config.siteMetadata.url}/fonts/paperboy-content-regular.woff2`} type="font/woff2" as="font" crossorigin />
			</head>
			<body>
