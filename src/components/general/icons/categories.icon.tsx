...
const IconCategories: React.FunctionComponent<IIconCategoriesProps> = props => (
	...
	>
		...
		<polygon
			...
			points="9.68 4.33 9.68 9.75 3.05 9.75 3.05 2.17 9.69 2.17 9.68 4.33"
		/>
		<polygon
			className="tab__icon--negative"
			points="23 4.33 23 9.75 16.32 9.75 16.32 2.17 23 2.17 23 4.33"
		/>
		<polygon
			className="tab__icon--negative"
			points="23 18.42 23 23.83 16.32 23.83 16.32 16.25 23 16.25 23 18.42"
		/>
		<polygon
			className="tab__icon--negative"
