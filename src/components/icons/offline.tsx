...
export const IconOffline: FunctionComponent = () => (
	<Icon xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" aria-hidden="true" tabIndex={-1}>
		<path
			fill="var(--offline-fill-color)"
...
const Icon = styled.svg`
	--offline-fill-color: var(--color-gray9);
	width: 100%;
	height: 100%;

	${theme.dark`
		--offline-fill-color: var(--color-gray1);
	`};
`;
